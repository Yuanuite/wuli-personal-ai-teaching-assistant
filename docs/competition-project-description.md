...
截至 2026 年 7 月 25 日，项目已完成可运行的高中物理 MVP：
...
- 当前 187 项 Python 自动化测试通过，覆盖答案复核失效、Agent Gateway 隔离与降级、结构化解析、模型注册表/逐模型测试、后台作业、反馈事件链、派生检索一致性、文件夹同步、可视化门禁、公开发布与隐私边界；另有 2 项环境相关跳过和 3 条隔离 E2E 场景实际操作浏览器与本地 API。
