...
if task.get("kind") == "diagram.scene":
    ...
    print(json.dumps({
        ...
        "regions": [{"id": "r1", "panel_id": "p1", "kind": "electric", "x": 8, "y": 12, "width": 84, "height": 72, "label": "物理场区", "fact_ids": fact_ids, "direction": "right"}],
        "objects": [{"id": "o1", "panel_id": "p1", "kind": "particle", "x": 15, "y": 55, "width": 4, "height": 6, "label": "粒子", "fact_ids": [], "polarity": "positive"}],
        "paths": [{"id": "t1", "panel_id": "p1", "kind": "trajectory", "geometry": "smooth", "points": [{"x": 18, "y": 58}, {"x": 45, "y": 45}, {"x": 78, "y": 22}], "label": "运动轨迹", "direction": "right", "fact_ids": []}],
        "annotations": [], "omissions": [],
        "model": "fake-diagram", "model_tier": "standard", "requested_tier": task.get("routing_tier", "auto"),
        "usage": {"prompt_tokens": 80, "completion_tokens": 40, "total_tokens": 120},
    }, ensure_ascii=False))
    raise SystemExit(0)
