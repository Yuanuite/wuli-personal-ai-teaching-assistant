...
class RetrievalReviewTest(unittest.TestCase):
    ...
    def test_save_approval_updates_the_private_fixed_set(self):
        ...
        persisted = server.retrieval_benchmark.load_cases(server.retrieval_benchmark.default_cases_path(self.library))[
            0
        ]
